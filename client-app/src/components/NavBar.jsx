...
function NavigationBar({ topChildren, botChildren, notificationChildren }) {
  ...
  return (
    <div className="h-[calc(100vh-74px)] w-60 flex flex-col items-start relative bg-black">
      ...
      <div className="relative flex flex-col py-6 items-center w-full box-border overflow-hidden h-[54%]">
        {topChildren}
      </div>
      ...
      <div className="relative flex flex-col py-6 items-center w-full box-border overflow-hidden h-[20%]">
        {botChildren}
      </div>     
    </div>
  );
